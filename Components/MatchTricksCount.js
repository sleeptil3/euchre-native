...
export default function MatchTricksCount() {
	const { matchTricks, callingPlayer, teamScore, opponentScore } = useContext(DataContext)

	/*<Subtitle align="center" override={{ fontSize: 8, padding: 2, marginBottom: 0 }}>|</Subtitle> */
	return (
