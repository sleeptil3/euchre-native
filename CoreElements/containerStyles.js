...
export const Flex = ({ direction, children, justify, align, color, safe, fill, height, width, override }) => {
	return safe ?
		...
		: <View style={[{ flex: fill || 1, flexDirection: direction ? direction : "column", height: height || "auto", width: width || "auto", justifyContent: justify, alignItems: align, backgroundColor: color || "transparent" }, { ...override }]}>{children}</View>
}